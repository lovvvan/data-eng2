...
instance = nova.servers.create(name="lovisa_prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='lovisa-key-data2',userdata=userdata, nics=nics,security_groups=secgroups)
