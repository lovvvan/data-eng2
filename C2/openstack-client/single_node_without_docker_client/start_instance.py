...
instance = nova.servers.create(name="Lovisa-hedman-prod_server_without_docker_"+str(identifier), image=image, flavor=flavor,userdata=userdata, nics=nics,security_groups=secgroups)
